...
(() => {
  ...
  if (magicJS.isResponse) {
    const trustedDomain = /^https?:\/\/(app|api\.live|api\.vc|api)\.bilibili\.com\//;
    if (!magicJS.request || !trustedDomain.test(magicJS.request.url)) {
      magicJS.done();
      return;
    }
    switch (true) {
